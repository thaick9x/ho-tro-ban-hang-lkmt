	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (info.getQuyen().equals("nvgd")) {
				request.getSession().setAttribute("infoNVGD", nhanVien.getThongTinNV(info.getUserID()));
			} else {
				request.getSession().setAttribute("infoNVK", nhanVien.getThongTinNV(info.getUserID()));
			}
