...
/*
 * Class chứa các hàm liên quan tới bảng thong_tin_gio_hang
 */

public class DaoGioHang extends DAO {
	...
	public CartInfo getCartInfoGD(String maGio) throws Exception {
		...
		kq.setTenLK(new DaoTTLK().getNameLK(kq.getMaTenLK()));
		return kq;
	}
	...
	// Đổi trạng thái giỏ hàng và thêm quầy xử lí
	...
	// Trả danh sách các giỏ hàng cần giao dịch
	public DsGioGD getReadyCarts(String quay) throws Exception {
		DsGioGD kq = new DsGioGD();
